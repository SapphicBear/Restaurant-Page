export function pageLoad() {
    ...
    DOM.appendChild(document.createElement("div")).className = "home-wrapper";
    document.querySelector(".home-wrapper").appendChild(div).className = "header";
    ...
    document.querySelector(".home-wrapper").appendChild(document.createElement("div")).className = "info";
    ...
    document.querySelector(".home-wrapper").appendChild(document.createElement("div")).className = "main";
    ...
    document.querySelector(".home-wrapper").appendChild(document.createElement("div")).className = "call-to-action";
    ...
    document.querySelector(".home-wrapper").appendChild(document.createElement("div")).className = "footer";
